...
public class mainCollection {
	public static void main (String[] args) {
		...
		/* Les set sont un peu comme les List mais adapté à la manipulation d'un grand nombre d'objet.
		Attention pour inserer des données de maniere ordonée, utiliser une list */
	}
}
